...
def autoExtract():
	...
	for path, basename in workingPaths:
		...
		if not(os.path.isfile(path+'/'+basename+'.prm')):
			RHDtoDATprbPRMmda.RHDtoDATprbPRM(path, basename, 'A1x32-Poly2-5mm-50s-177-A32.prb') # 'ASSY-37W-DBC11A-intan.prb' this is Brendan's edge probe from Cambridge Neurotech
