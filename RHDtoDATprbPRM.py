...
def RHDtoDATprbPRM(dataPath,basename,probefile):
	...
	basename is the common string that this program will find in the filename to extract RHD files and to generate new .dat and .kwik files.
	probefile is a string describing the probe; currently, 'A1x32-Poly2-5mm-50s-177-A32.prb' and 'Buzsaki32.prb' are accepted.
	"""
	if probefile != 'A1x32-Poly2-5mm-50s-177-A32.prb' and probefile != 'Buzsaki32.prb':
